...
public class set_alarm extends Activity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alarm_bus_no_spinner.setOnItemSelectedListener(this);
        ...
        final Spinner bound_spinner = (Spinner) findViewById(R.id.spinner_alarm_direction);
        // Spinner click listener
